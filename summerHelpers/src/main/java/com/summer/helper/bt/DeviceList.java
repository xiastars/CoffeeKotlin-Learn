...
//
//
//package com.shenqijiazu.helper.bt;
//
//import java.util.Set;
//
//import com.shenqijiazu.childrenpad.launcher.R;
//import com.shenqijiazu.helper.utils.SUtils;
//
...
//                /* 设置自动连接蓝牙;前提是用户已连接成功一次 */
//                String name = SUtils.getStringData(this, AcBluetooth.JLBLUETOOTH_NAME);
//                if(name.equals(device.getName())){
//                	 Intent intent = new Intent();
//                	 intent.putExtra(BluetoothState.EXTRA_DEVICE_ADDRESS, device.getAddress());
