...
public class BluetoothService {
    ...
    private UUID UUID_OTHER_DEVICE =
            UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    public static final UUID UUIP_PHONE_DEVICE = 
...
//    		
//    	}
//        UUID_OTHER_DEVICE = device.getUuids()[0].getUuid();
...
//                    }
                	...
                	if (nAvail > 0) {   
                		...
                		if (null !=  mHandler) {
                			mHandler.obtainMessage(BluetoothState.MESSAGE_READ, nRead, -1, subBuf).sendToTarget();
                		}
                	} else {
...
//            	Logs.i("byte",Arrays.toString(buffer));
