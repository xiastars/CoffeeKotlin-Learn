...
public class RoundAngleImageView extends ImageView {
	...
	public RoundAngleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		if(backDrawable != null){
			...
			backDrawable = RoundedDrawable.fromDrawable(context.getResources().getDrawable(R.drawable.trans));
		}
    ...
    protected void onDraw(Canvas canvas) {
        ...
        tempCanvas.drawCircle(getWidth() / 2, getHeight() / 2, outerCircleRadiusProgress * maxCircleSize  *0.2f, circlePaint);
        tempCanvas.drawCircle(getWidth() / 2, getHeight() / 2, innerCircleRadiusProgress * maxCircleSize  *0.2f , maskPaint);
